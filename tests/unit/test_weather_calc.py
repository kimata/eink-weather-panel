...
class TestCalcMisnarFormula:
    ...
    def test_wind_lowers_perceived_temperature(self):
        ...
        temp_no_wind = _calc_misnar_formula(temp, humi, 0)
        temp_with_wind = _calc_misnar_formula(temp, humi, 5)
    ...
    def test_humidity_affects_perceived_temperature(self):
        ...
        temp_low_humi = _calc_misnar_formula(temp, 30, wind)
        temp_high_humi = _calc_misnar_formula(temp, 80, wind)
    ...
    def test_returns_float(self):
        ...
        result = _calc_misnar_formula(25, 50, 2)
    ...
    def test_various_wind_speeds(self, wind):
        ...
        result = _calc_misnar_formula(25, 50, wind)
    ...
    def test_various_humidity_levels(self, humi):
        ...
        result = _calc_misnar_formula(25, humi, 2)
...
class TestRotationMap:
    ...
    def test_rotation_map_values_are_valid(self):
        ...
        for direction, angle in _ROTATION_MAP.items():
